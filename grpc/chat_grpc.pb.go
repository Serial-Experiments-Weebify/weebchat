...
const (
	MessageBoard_CreateUser_FullMethodName          = "/chat.MessageBoard/CreateUser"
	MessageBoard_CreateTopic_FullMethodName         = "/chat.MessageBoard/CreateTopic"
	MessageBoard_PostMessage_FullMethodName         = "/chat.MessageBoard/PostMessage"
	MessageBoard_LikeMessage_FullMethodName         = "/chat.MessageBoard/LikeMessage"
	MessageBoard_GetSubscriptionNode_FullMethodName = "/chat.MessageBoard/GetSubscriptionNode"
	MessageBoard_ListTopics_FullMethodName          = "/chat.MessageBoard/ListTopics"
	MessageBoard_GetMessages_FullMethodName         = "/chat.MessageBoard/GetMessages"
...
type MessageBoardClient interface {
	...
	// Chain replication payload transfer
...
func (c *messageBoardClient) ChainReplicate(ctx context.Context, in *ChainPayload, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, MessageBoard_ChainReplicate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageBoardClient) ReconfigureNode(ctx context.Context, in *NodeConfiguration, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, MessageBoard_ReconfigureNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMessageBoardServer) ChainReplicate(context.Context, *ChainPayload) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ChainReplicate not implemented")
}
...
func _MessageBoard_ChainReplicate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChainPayload)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MessageBoardServer).ChainReplicate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageBoard_ChainReplicate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageBoardServer).ChainReplicate(ctx, req.(*ChainPayload))
	}
	return interceptor(ctx, in, info, handler)
}

func _MessageBoard_ReconfigureNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeConfiguration)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MessageBoardServer).ReconfigureNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageBoard_ReconfigureNode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageBoardServer).ReconfigureNode(ctx, req.(*NodeConfiguration))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MessageBoard_CloneTail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(MessageBoardServer).CloneTail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var MessageBoard_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChainReplicate",
			Handler:    _MessageBoard_ChainReplicate_Handler,
		},
		{
		...
		{
			MethodName: "CloneTail",
			Handler:    _MessageBoard_CloneTail_Handler,
		},
	},
